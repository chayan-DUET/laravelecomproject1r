...
<h3 class="text-center text-success">{{Session::get('massage')}}</h3>
        ...
        <div class="well">
            ...
            <div class=" form-group">
                ...
                <div class="col-sm-10">
                    <textarea class="form-control" name="manufactureDiscription" rows="8"></textarea>
                      <span class="text-danger">{{$errors->has('manufactureDiscription')?$errors->first('manufactureDiscription'):''}}</span>
                </div>
            </div>
