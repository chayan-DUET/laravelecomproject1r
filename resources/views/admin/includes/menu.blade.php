<div class="sidebar-nav navbar-collapse">
    <ul class="nav" id="side-menu">
        ...
        <li>
            ...
            <ul class="nav nav-second-level">
                <li>
                    <a href="{{url('/manufacture/add')}}">Add Manufacturer</a>
                </li>
                <li>
                    <a href="{{url('/manufacture/manage')}}">Manage Manufacturer</a>
                </li>
            </ul>
            <!-- /.nav-second-level -->
        </li>
		...
		<!--                       Manage Order-->
        <li>
            <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i> Manage Order Info<span class="fa arrow"></span></a>
            <ul class="nav nav-second-level">
                <li>
                    <a href="{{URL::to('/manage-order')}}">Manage Order</a>
                </li>
                <li>
