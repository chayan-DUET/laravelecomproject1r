	...
	<div id="visual">
			<div class="slide-visual">
				...
				<ul class="slide-group">
					@foreach($publishedSlider as $published_slider)
					<li><img class="img-responsive" src="{{asset($published_slider->slider_image)}}" alt="Dummy Image" style="height:500px;width:700px" /></li>
					    @endforeach
				</ul>
				...
				<div class="script-wrap">
					...
					@foreach($publishedSlider as $published_slider)
						<li><div class="inner-script"><img class="img-responsive" src="{{asset($published_slider->slider_image)}}" alt="Dummy Image" style="height:250px;width:200px"/></div></li>
...
<!--										<del>$69.71</del>-->
					...
					<div class="tab-1 resp-tab-content" aria-labelledby="tab_item-1">
                                            @foreach($publishedCategoryProducts as $publishedProduct)
						<div class="col-md-3 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								<div class="men-thumb-item">
