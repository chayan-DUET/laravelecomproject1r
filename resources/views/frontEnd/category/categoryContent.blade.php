...
<!--  call api  <script>
        $.ajax({url: "http://localhost/laravelecomproject/api", success: function (result) {


var r=JSON.parse(result);
                alert(r[0].productImage)
                
                $( "div.apiresp" ).html( "<img src=\"http://localhost/laravelecomproject/"+r[0].productImage+"\"/>" );
            }});
    </script>-->
</div>	
@endsection
