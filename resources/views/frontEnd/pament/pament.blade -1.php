...
<!-- //for-mobile-apps -->
<link href="{{asset('public/frontEnd/csspmt/style.css')}}" rel="stylesheet" type="text/css" media="all" />
<link href='//fonts.googleapis.com/css?family=Fugaz+One' rel='stylesheet' type='text/css'>
<link href='//fonts.googleapis.com/css?family=Alegreya+Sans:400,100,100italic,300,300italic,400italic,500,500italic,700,700italic,800,800italic,900,900italic' rel='stylesheet' type='text/css'>
<link href='//fonts.googleapis.com/css?family=Open+Sans:400,300,300italic,400italic,600,600italic,700,700italic,800,800italic' rel='stylesheet' type='text/css'>
<script type="text/javascript" src="{{asset('public/frontEnd/jspmt/jquery.min.js')}}"></script>
</head>
<body class="b">
	<div class="mainpmt">
		<h1>Payment Form Widget <a href="/ecomers/laravelecomproject1r/" class="btn btn-info btn-lg">
          <span class="glyphicon glyphicon-home"></span> Home
        </a></h1>
		<div class="contentpmt">
			
			<script src="{{asset('public/frontEnd/jspmt/easyResponsiveTabs.js')}}" type="text/javascript"></script>
							   ...
							   <form action="{{url('/order-place')}}" method="post">
								...
								<div class="pay-tabs">
									<h2>Select Payment Method</h2>
									  <div class="resp-tabs-listpmt">
										  <li class="resp-tab-item" aria-controls="tab_item-0" role="tab"><span><label class="pic1">
										  <input type="radio" name="pament_getway" value="cradit cart">
										  </label>Credit Card</span></li>
										  <li class="resp-tab-item" aria-controls="tab_item-1" role="tab"><span><label class="pic3">
										   <input type="radio" name="pament_getway" value="net banking">
										  </label>Net Banking</span></li>
										  <li class="resp-tab-item" aria-controls="tab_item-2" role="tab"><span><label class="pic4">
										   <input type="radio" name="pament_getway" value="paple ">
										  </label>PayPal</span></li> 
										  <li class="resp-tab-item" aria-controls="tab_item-3" role="tab"><span><label class="pic2">
										   <input type="radio" name="pament_getway" value="dabit cart">
								...
								<div class="resp-tabs-containerpmt">
		...
		<p class="footerpmt">Copyright © 2016 Payment Form Widget. All Rights Reserved | Template by <a href="https://w3layouts.com/" target="_blank">w3layouts</a></p>
	</div>
</body>
</html>