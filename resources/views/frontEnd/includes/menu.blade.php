                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse menu--shylock" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav menu__list">
                           ...
                           @foreach($publishedCategory as $publishedCategories)
                            <li class="dropdown menu__item">
                                <a href="{{url('/category-view/'.$publishedCategories->id)}}" class="dropdown-toggle menu__link" >{{$publishedCategories->categoryName}} <span class="caret"></span></a>
...
<!--                            </li>-->
<!--  default menu   close                        <li class="dropdown menu__item">
                ...
                <a href="{{url('/show-cart')}}">
                    <h3> <div class="total">
                          <!--   <i class="glyphicon glyphicon-shopping-cart" aria-hidden="true"></i>
							...
							(<!--  <span id="simpleCart_quantity" class="simpleCart_quantity"></span>-->{{Cart::count()}} items)</div>

                    </h3>
                </a>
                <p><a href="javascript:;" class="simpleCart_empty">{{(Cart::total())}}</a></p>
